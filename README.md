...
Необходимо написать приложение с использованием `BottomNavigationView`, представляющее записную книжку. Приложение запускается со стартового экрана, название приложения и `imageView` происходит с анимацией.
...
```bash
git clone --branch=BottomNavigationView https://github.com/PawPrintsInTheDark/AndroidLessons.git
